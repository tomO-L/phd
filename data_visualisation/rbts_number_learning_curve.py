...
plot_learning_curve(int_start_trap_ratio_persession, mice_to_analyse, ax1)
ax1.set_ylabel('Ratio of\n starting interior trapeze')
ax1.set_ylim([0,1])
ax1.axhline(0.5,0,20, color='grey', linestyle='--')

plot_learning_curve(int_end_trap_ratio_persession, mice_to_analyse, ax2)
ax2.set_ylabel('Ratio of\n ending interior trapeze')
ax2.set_ylim([0,1])
ax2.axhline(0.5,0,20, color='grey', linestyle='--')

plot_learning_curve(ext_start_trap_ratio_persession, mice_to_analyse, ax3)
ax3.set_ylabel('Ratio of\n starting exterior trapeze')
ax3.set_ylim([0,1])
ax3.axhline(0.5,0,20, color='grey', linestyle='--')

plot_learning_curve(ext_end_trap_ratio_persession, mice_to_analyse, ax4)
