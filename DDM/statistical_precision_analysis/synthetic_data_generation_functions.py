...
def run_simulation(p_a, p_a_reward, steps_number, noise_amplitude, delta, drift):
    ...
    ddm_result = {'parameters': [p_a, p_a_reward, steps_number, noise_amplitude, delta, drift],'rewards': np.array(reward_sequence), 'choices': np.array(choice_sequence), 'p_a': np.array(p_a_sequence), 'drift': np.array(drift_sequence)}
