...
n_simulations = 60
simulations_indexes = np.arange(60)

with open(f'DDM_v2/statistical_precision_analysis/simulations_batches/simulations_batch_{n_simulations}_test_2.pkl', 'rb') as file:
