...
for i, n_simulations in enumerate(n_simulations_list):
    ...
    with open(f'DDM_v2/statistical_precision_analysis/simulations_batches/n_{n_simulations}/simulations_batch_{n_simulations}_test_{i+1}.pkl', 'wb') as file:
