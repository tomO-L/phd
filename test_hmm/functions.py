...
def infer_best_model_score(x_train, x_validate, training_lengths, validation_lengths, n_to_test, n_features = 4, seed=13):
    # check optimal score
...
def infer_best_model_aic(x_train, x_validate, training_lengths, validation_lengths, n_to_test, n_features = 4, seed=13):
    # check optimal score
